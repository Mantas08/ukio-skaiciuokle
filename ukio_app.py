        ...
        if sdf.empty:
            ...
            if prod_ids:
                for pid in prod_ids:
                    ...
                    with pc2:
                        norma = st.number_input(
                            "Norma (" + pr["vienetas"] + "/ha)",
                    ...
                    with pc3:
                        ...
                        if norma > 0:
                            st.markdown(
                                str(plotas) + " ha x " + str(norma) + " = **" +
                                str(round(sun, 2)) + " " + pr["vienetas"] +
                                "** | **" + str(round(suma, 2)) + " EUR**"
                            )
                            if sun > pr["kiekis"]:
                ...
                st.markdown("---")
                st.markdown("### Bendra suma: " + str(round(bendra_suma, 2)) + " EUR")
                ...
                if st.button("Registruoti darba", type="primary", use_container_width=True, key="nd_submit"):
                    if not idarbas:
                        ...
                        st.success("Registruota produktu: " + str(reg_count) + " | Bendra suma: " + str(round(reg_suma, 2)) + " EUR")
                        st.rerun()
